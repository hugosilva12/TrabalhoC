...
${OBJECTDIR}/FuncionariosFx.o: FuncionariosFx.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionariosFx.o FuncionariosFx.c

${OBJECTDIR}/GestaoFuncionarios.o: GestaoFuncionarios.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestaoFuncionarios.o GestaoFuncionarios.c

${OBJECTDIR}/Listagens.o: Listagens.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Listagens.o Listagens.c
...
${OBJECTDIR}/ProcessamentoSalario.o: ProcessamentoSalario.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessamentoSalario.o ProcessamentoSalario.c

${OBJECTDIR}/ProcessamentoSalarioFX.o: ProcessamentoSalarioFX.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessamentoSalarioFX.o ProcessamentoSalarioFX.c

${OBJECTDIR}/TabelaIrs.o: TabelaIrs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TabelaIrs.o TabelaIrs.c

${OBJECTDIR}/TabelaSegurancaSocial.o: TabelaSegurancaSocial.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TabelaSegurancaSocial.o TabelaSegurancaSocial.c
...
${OBJECTDIR}/logMsg.o: logMsg.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/logMsg.o logMsg.c
